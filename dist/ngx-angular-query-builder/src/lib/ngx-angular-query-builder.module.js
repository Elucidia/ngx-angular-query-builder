...
let NgxAngularQueryBuilderModule = class NgxAngularQueryBuilderModule {
};
NgxAngularQueryBuilderModule = __decorate([
    NgModule({
...
export { NgxAngularQueryBuilderModule };
//# sourceMappingURL=ngx-angular-query-builder.module.js.map